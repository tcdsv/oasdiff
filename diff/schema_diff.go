...
func getSchemaDiffInternal(config *Config, state *state, schema1, schema2 *openapi3.SchemaRef) (*SchemaDiff, error) {
	...
	result.FormatDiff = getValueDiffConditional(config.IsExcludeFormat(), value1.Format, value2.Format)
	...
	result.DefaultDiff = getValueDiffConditional(config.IsExcludeDefault(), value1.Default, value2.Default)
	...
	result.AdditionalPropertiesAllowedDiff = getBoolRefDiffConditional(config.IsExcludeAdditionalPropertiesAllowed(), value1.AdditionalProperties.Has, value2.AdditionalProperties.Has)
	result.UniqueItemsDiff = getValueDiffConditional(config.IsExcludeUniqueItems(), value1.UniqueItems, value2.UniqueItems)
	result.ExclusiveMinDiff = getValueDiffConditional(config.IsExcludeExclusiveMin(), value1.ExclusiveMin, value2.ExclusiveMin)
	result.ExclusiveMaxDiff = getValueDiffConditional(config.IsExcludeExclusiveMax(), value1.ExclusiveMax, value2.ExclusiveMax)
	result.NullableDiff = getValueDiffConditional(config.IsExcludeNullable() ,value1.Nullable, value2.Nullable)
	result.ReadOnlyDiff = getValueDiffConditional(config.IsExcludeReadOnly(), value1.ReadOnly, value2.ReadOnly)
	result.WriteOnlyDiff = getValueDiffConditional(config.IsExcludeWriteOnly(), value1.WriteOnly, value2.WriteOnly)
	result.AllowEmptyValueDiff = getValueDiffConditional(config.IsExcludeAllowEmptyValue(), value1.AllowEmptyValue, value2.AllowEmptyValue)
	result.XMLDiff = getValueDiffConditional(config.IsExcludeXML(), value1.XML, value2.XML)
	result.DeprecatedDiff = getValueDiffConditional(config.IsExcludeDeprecated(), value1.Deprecated, value2.Deprecated)
	result.MinDiff = getFloat64RefDiffConditional(config.IsExcludeMin(), value1.Min, value2.Min)
	result.MaxDiff = getFloat64RefDiffConditional(config.IsExcludeMax(), value1.Max, value2.Max)
	result.MultipleOfDiff = getFloat64RefDiffConditional(config.IsExcludeMultipleOf(), value1.MultipleOf, value2.MultipleOf)
	result.MinLengthDiff = getValueDiffConditional(config.IsExcludeMinLength(), value1.MinLength, value2.MinLength)
	result.MaxLengthDiff = getUInt64RefDiffConditional(config.IsExcludeMaxLength(), value1.MaxLength, value2.MaxLength)
	result.PatternDiff = getValueDiffConditional(config.IsExcludePattern(), value1.Pattern, value2.Pattern)
	// compiledPattern is derived from pattern -> no need to diff
	result.MinItemsDiff = getValueDiffConditional(config.IsExcludeMinItems(), value1.MinItems, value2.MinItems)
	result.MaxItemsDiff = getUInt64RefDiffConditional(config.IsExcludeMaxItems(), value1.MaxItems, value2.MaxItems)
	...
	result.MinPropsDiff = getValueDiffConditional(config.IsExcludeMinProps(), value1.MinProps, value2.MinProps)
	result.MaxPropsDiff = getUInt64RefDiffConditional(config.IsExcludeMaxProps(), value1.MaxProps, value2.MaxProps)
